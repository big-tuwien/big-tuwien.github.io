...
abstract: The most prominent business ontology for accounting information systems
  ...
  process.<br> <br> Consequently, we have developed a domain specific modeling language
  for the REA concepts called the REA-DSL which aims at both (i) delivering an intuitive
...
date: '2012-02-20'
featured: false
publication: '*Business-Model-Driven Data Engineering Using the REA-DSL*'
publication_types:
- '0'
