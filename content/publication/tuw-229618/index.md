...
abstract: In software modeling, the Object Constraint Language (OCL) is an important
  ...
  models that capture the execution of the system.<br> In this paper, we show how
  OCL can be extended with CTL-based temporal operators to express properties over
  the lifetime of an instance model. We formally ntroduce syntax and semantics of
  our OCL extension cOCL. The properties specified with our OCL extension can be verified
...
date: '2014-01-01'
featured: false
publication: '*Model Checking of CTL-Extended OCL Specifications*'
publication_types:
- '4'
