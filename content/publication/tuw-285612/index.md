...
abstract: The goal of Building Information Modeling (BIM) is the continuous use of
  ...
  aspect of BIM.<br> As a proof-of-concept we show the application of our data model
  in an ongoing project. We demonstrate the completeness of our data model and the
  fulfillment of the requirements of the design phase. The result shows that the flexible
  data model of SIMULTAN can be better adapted to the task. Another significant advantage
...
date: '2019-06-17'
featured: false
publication: '*SIMULTAN as a Big-Open-Real-BIM Data Model - Proof of Concept for the
  Design Phase*'
publication_types:
- '0'
