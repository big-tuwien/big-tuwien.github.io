...
abstract: Shape grammars have been introduced in architectural theory some decades
  ...
  architects (e.g. Palladio, Frank Lloyd-Wright).<br> These examples demonstrated
  that complex geometrical shapes could be generated by a set of replacement rules
  out of a start symbol, usually a simple geometric shape. With the advent of powerful
  tools like the CityEngine an interesting field for practical applications of these
  grammars arose opening a whole range of new possibilities for architectural heritage.<br>
  ...
  scale creation of 3D models of entire settlements and cities.<br> On the other hand,
  ...
  feature.<br> In this paper we reconsider shape grammars in architecture and examine
  influences onto procedural modelling. Then we argue for state-of-the-art tools like
  the CityEngine that apply shape grammars and<br> procedural modelling in architectural
...
date: '2012-04-19'
featured: false
publication: '*Shape Grammars for Architectural Heritage*'
publication_types:
- '0'
